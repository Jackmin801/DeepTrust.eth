...
class LlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.deeptrust_commit: Optional[Commit] = None
    ...
    def forward(
        ...
        if self.deeptrust_commit is not None:
            detached_hidden_states: torch.Tensor = hidden_states.detach()  # R[B, S, D]
            if self.deeptrust_commit.completion is None:  # Generate case
                self.deeptrust_commit.hashes.append(
                ...
                prefill_view = detached_hidden_states.as_strided(
                    ...
                    (self.deeptrust_commit.input_tokens * _hidden_dim, _hidden_dim, 1),
                )
                self.deeptrust_commit.hashes.append((hash_tensor(prefill_view)))
